...
sys.path.append('C:/Users/Administrator/Desktop/Async-LinUCB-master/Dataset/SimArticles')
sys.path.append('C:/Users/Administrator/Desktop/Async-LinUCB-master/Dataset/MovieLen')
...
class LinGapE_full:
	def __init__(self, dimension, epsilon, delta, NoiseScale, K, dataset, case, gap):
		...
		if dataset == 0:
			theta_filename = 'C:/Users/Administrator/Desktop/Async-LinUCB-master/Dataset/MovieLen/150wtheta.dat'
			self.theta = []
			...
			movie_filname = 'C:/Users/Administrator/Desktop/Async-LinUCB-master/Dataset/MovieLen/MovieLen' + str(gap/10) + '_' + str(self.K) + '.dat'
			...
			# self.X = np.zeros((len(movies), 25), dtype=float)
			# for i in range(self.K):
			# 	# print(self.X[i].shape)
			# 	# print(movies[i].featureVector.shape)
			# 	self.X[i] = movies[i].featureVector
