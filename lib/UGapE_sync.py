...
class UGapE_mult:
	def __init__(self, dimension, epsilon, delta, NoiseScale,  dataset, case, gap):
		...
		if dataset == 0:
			...
			User_filename = 'C:/Users/Administrator/Desktop/Async-LinUCB-master/Dataset/SimArticles/usersHomo.dat'
			...
			Article_filename = 'C:/Users/Administrator/Desktop/Async-LinUCB-master/Dataset/SimArticles/ArticlesForHomo_' + str(gap/10) + '_' + str(5) + '.dat'
